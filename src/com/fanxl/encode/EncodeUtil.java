...
/**
 * @description:  https://www.cnblogs.com/jpfss/p/9889804.html
 * @author: fanxiaole
...
public class EncodeUtil {
    ...
    public static void main(String[] args) {
        // 字符 转 UTF-8
        System.out.println(EncodeUtil.convertStringToUTF8("啊"));
        // UTF-8 转 字符
        System.out.println(EncodeUtil.convertUTF8ToString(EncodeUtil.convertStringToUTF8("啊")));
        ...
        String s1 = EncodeUtil.convertStringToUTF8(EncodeUtil.unicodeToString(str1));
